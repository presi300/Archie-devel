...
echo "You have chosen Xorg/X11 as your graphics platform"
echo "-------------------------------------------------------------------"
...
if [ $efi -eq 1 ]; then
    ...
    echo "Since you chose to do your partitions manually"
    echo "you now have to select whether you system is BIOS or UEFI"
    echo "-------------------------------------------------------------------"
    echo "1 - BIOS"
    echo "2 - UEFI"
    echo "-------------------------------------------------------------------"
    read -p "Enter your choice: " bios
    if [ $bios -eq 1 ]
    then
        clear
        echo "You have selected BIOS"
...
then
    ...
    read k
    pacman -S xorg sddm plasma firefox konsole qt5 networkmanager dolphin bluez bluez-utils noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra git kate vlc ark unzip --noconfirm
...
then
    ...
    echo "Press enter to proceed with installation..."
    read g
    pacman -S gnome gnome-tweaks gnome-nettool gnome-usage adwaita-icon-theme firefox vlc gedit archlinux-wallpaper gdm gnome-terminal networkmanager gparted git noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra --noconfirm
